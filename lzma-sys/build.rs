...
fn main() {
    ...
    let include_dir = env::current_dir().unwrap().join("xz-5.8.3/src/liblzma/api");
    println!("cargo:include={}", include_dir.display());

    let mut src_files = [
        "xz-5.8.3/src/liblzma/common",
        "xz-5.8.3/src/liblzma/lzma",
        "xz-5.8.3/src/liblzma/lz",
        "xz-5.8.3/src/liblzma/check",
        "xz-5.8.3/src/liblzma/delta",
        "xz-5.8.3/src/liblzma/rangecoder",
        "xz-5.8.3/src/liblzma/simple",
    ]
    .iter()
    .flat_map(|dir| read_dir_files(dir))
    .chain(vec![
        "xz-5.8.3/src/common/tuklib_cpucores.c".into(),
        "xz-5.8.3/src/common/tuklib_physmem.c".into(),
    ])
    .collect::<Vec<_>>();
    ...
    build
        ...
        .include("xz-5.8.3/src/liblzma/api")
        .include("xz-5.8.3/src/liblzma/lzma")
        .include("xz-5.8.3/src/liblzma/lz")
        .include("xz-5.8.3/src/liblzma/check")
        .include("xz-5.8.3/src/liblzma/simple")
        .include("xz-5.8.3/src/liblzma/delta")
        .include("xz-5.8.3/src/liblzma/common")
        .include("xz-5.8.3/src/liblzma/rangecoder")
        .include("xz-5.8.3/src/common")
